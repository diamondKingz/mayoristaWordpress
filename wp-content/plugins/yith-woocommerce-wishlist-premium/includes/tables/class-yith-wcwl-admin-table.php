...
if ( ! class_exists( 'YITH_WCWL_Admin_Table' ) ) {
	...
	class YITH_WCWL_Admin_Table extends WP_List_Table {
		...
		public function column_name( $item ) {
			...
			/**
			 * APPLY_FILTERS: yith_wcwl_admin_table_column_name_actions
			 *
			 * Filter the row actions for each wishlist in the Wishlists table.
			 *
			 * @param array              $actions             Array of actions to apply to each wishlist
			 * @param YITH_WCWL_Wishlist $item                Wishlist object
			 * @param string             $delete_wishlist_url URL to delete wishlist
			 *
			 * @return string
			 */
