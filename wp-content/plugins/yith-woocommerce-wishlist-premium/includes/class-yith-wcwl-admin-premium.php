...
if ( ! class_exists( 'YITH_WCWL_Admin_Premium' ) ) {
	...
	class YITH_WCWL_Admin_Premium extends YITH_WCWL_Admin_Extended {
		...
		public function init() {
			...
			$available_tabs = yith_wcwl_merge_in_array(
				$available_tabs,
				array(
			...
			// add new tabs.
			/**
			 * APPLY_FILTERS: yith_wcwl_available_admin_tabs_premium
			 *
			 ...
			 * @return array
			 */
			$this->available_tabs = apply_filters( 'yith_wcwl_available_admin_tabs_premium', $available_tabs );
